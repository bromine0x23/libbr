...
static Float64 pos_zero = BR::Detail::Math::to_float64(0x00000000, 0x00000000U);
static Float64 neg_zero = -pos_zero;
static Float64 pos_min_subnormal = BR::Detail::Math::to_float64(0x00000000, 0x00000001U);
static Float64 neg_min_subnormal = -pos_min_subnormal;
static Float64 pos_max_subnormal = BR::Detail::Math::to_float64(0x000FFFFF, 0xFFFFFFFFU);
static Float64 neg_max_subnormal = -pos_max_subnormal;
static Float64 pos_min_normal = BR::Detail::Math::to_float64(0x00100000, 0x00000000U);
static Float64 neg_min_normal = -pos_min_normal;
static Float64 pos_max_normal = BR::Detail::Math::to_float64(0x7FEFFFFF, 0xFFFFFFFFU);
static Float64 neg_max_normal = -pos_max_normal;
static Float64 pos_inf = BR::Detail::Math::to_float64(0x7FF00000, 0x00000000U);
static Float64 neg_inf = -pos_inf;
static Float64 pos_nan = BR::Detail::Math::to_float64(0x7FFFFFFFFFFFFFFFLL);
