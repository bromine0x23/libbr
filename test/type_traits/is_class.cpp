...
TEST(TypeTraits, IsClass) {
	...
	IS_TRAITS_CHECK(false, Class, class, float);
	IS_TRAITS_CHECK(false, Class, class, char);
	IS_TRAITS_CHECK(false, Class, class, int *);
	IS_TRAITS_CHECK(false, Class, class, int &);
	IS_TRAITS_CHECK(false, Class, class, int &&);
	IS_TRAITS_CHECK(false, Class, class, int []);
	IS_TRAITS_CHECK(false, Class, class, int [2]);
	IS_TRAITS_CHECK(false, Class, class, int(int));
	IS_TRAITS_CHECK(false, Class, class, int(*)(int));
	IS_TRAITS_CHECK(false, Class, class, int(&)(int));
	IS_TRAITS_CHECK(false, Class, class, int(&&)(int));
	IS_TRAITS_CHECK(false, Class, class, int(Class::*));
	IS_TRAITS_CHECK(false, Class, class, int(Class::*)(int));
}