...
TEST(TypeTraits, IsFundamental) {
	...
	IS_TRAITS_CHECK(false, Fundamental, fundamental, CFunction<int, int>);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, CFunction<int, int> *);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, int Class::*);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, CFunction<int, int> Class::*);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, Class);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, Struct);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, Union);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, Enum);
	IS_TRAITS_CHECK(false, Fundamental, fundamental, EnumClass);
}