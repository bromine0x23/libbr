...
TEST(TypeTraits, IsIntegral) {
	...
	IS_TRAITS_CHECK(false, Integral, integral, void);
	IS_TRAITS_CHECK(false, Integral, integral, float);
	IS_TRAITS_CHECK(false, Integral, integral, double);
	IS_TRAITS_CHECK(false, Integral, integral, long double);
	IS_TRAITS_CHECK(false, Integral, integral, int *);
	IS_TRAITS_CHECK(false, Integral, integral, int &);
	IS_TRAITS_CHECK(false, Integral, integral, int &&);
	IS_TRAITS_CHECK(false, Integral, integral, int []);
	IS_TRAITS_CHECK(false, Integral, integral, int [2]);
	IS_TRAITS_CHECK(false, Integral, integral, CFunction<int, int>);
	IS_TRAITS_CHECK(false, Integral, integral, CFunction<int, int> *);
	IS_TRAITS_CHECK(false, Integral, integral, int Class::*);
	IS_TRAITS_CHECK(false, Integral, integral, CFunction<int, int> Class::*);
	IS_TRAITS_CHECK(false, Integral, integral, NullPointer);
	IS_TRAITS_CHECK(false, Integral, integral, Class);
	IS_TRAITS_CHECK(false, Integral, integral, Union);
	IS_TRAITS_CHECK(false, Integral, integral, Enum);
	IS_TRAITS_CHECK(false, Integral, integral, EnumClass);
}