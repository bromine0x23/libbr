...
TEST(TypeTraits, IsUnsigned) {
	IS_TRAITS_CHECK_CV(true , Unsigned, unsigned, unsigned char);
	IS_TRAITS_CHECK_CV(true , Unsigned, unsigned, unsigned short);
	IS_TRAITS_CHECK_CV(true , Unsigned, unsigned, unsigned int);
	IS_TRAITS_CHECK_CV(true , Unsigned, unsigned, unsigned long);
	IS_TRAITS_CHECK_CV(true , Unsigned, unsigned, unsigned long long);
