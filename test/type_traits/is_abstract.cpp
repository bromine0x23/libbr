...
TEST(TypeTraits, IsAbstract) {
	IS_TRAITS_CHECK(false, Abstract, void);
	IS_TRAITS_CHECK(false, Abstract, int);
	IS_TRAITS_CHECK(false, Abstract, int *);
	IS_TRAITS_CHECK(false, Abstract, int &);
	IS_TRAITS_CHECK(false, Abstract, int &&);
	IS_TRAITS_CHECK(false, Abstract, int(int));

	IS_TRAITS_CHECK_CV(false, Abstract, Class);
	IS_TRAITS_CHECK_CV(true , Abstract, Abstract);

	IS_TRAITS_CHECK_CV(false, Abstract, C00);
	IS_TRAITS_CHECK_CV(true , Abstract, C01);
	IS_TRAITS_CHECK_CV(true , Abstract, C02);
	IS_TRAITS_CHECK_CV(false, Abstract, C03);
	IS_TRAITS_CHECK_CV(true , Abstract, C04);
	IS_TRAITS_CHECK_CV(true , Abstract, C05);
	IS_TRAITS_CHECK_CV(false, Abstract, C06);
	IS_TRAITS_CHECK_CV(false, Abstract, C07);
	IS_TRAITS_CHECK_CV(true , Abstract, C08);
	IS_TRAITS_CHECK_CV(false, Abstract, C09);
	IS_TRAITS_CHECK_CV(true , Abstract, C10);
	IS_TRAITS_CHECK_CV(false, Abstract, C11);
	IS_TRAITS_CHECK_CV(true , Abstract, C12);
	IS_TRAITS_CHECK_CV(true , Abstract, C13);
	IS_TRAITS_CHECK_CV(true , Abstract, C14);
	IS_TRAITS_CHECK_CV(false, Abstract, C15);
	IS_TRAITS_CHECK_CV(true , Abstract, C16);
	IS_TRAITS_CHECK_CV(true , Abstract, C17);
	IS_TRAITS_CHECK_CV(false, Abstract, C18);
	IS_TRAITS_CHECK_CV(false, Abstract, C19);
	IS_TRAITS_CHECK_CV(true , Abstract, C20);
	IS_TRAITS_CHECK_CV(false, Abstract, C21);
	IS_TRAITS_CHECK_CV(true , Abstract, C22);
	IS_TRAITS_CHECK_CV(false, Abstract, C23);
	IS_TRAITS_CHECK_CV(true , Abstract, C24);
	IS_TRAITS_CHECK_CV(true , Abstract, C25);
	IS_TRAITS_CHECK_CV(true , Abstract, C26);
	IS_TRAITS_CHECK_CV(false, Abstract, C27);
	IS_TRAITS_CHECK_CV(true , Abstract, C28);
	IS_TRAITS_CHECK_CV(true , Abstract, C29);
	IS_TRAITS_CHECK_CV(false, Abstract, C30);
	IS_TRAITS_CHECK_CV(false, Abstract, C31);
	IS_TRAITS_CHECK_CV(false, Abstract, C32);
	...
	IS_TRAITS_CHECK_CV(false, Abstract, TC00<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC01<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC02<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC03<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC04<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC05<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC06<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC07<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC08<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC09<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC10<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC11<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC12<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC13<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC14<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC15<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC16<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC17<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC18<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC19<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC20<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC21<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC22<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC23<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC24<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC25<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC26<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC27<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC28<int>);
	IS_TRAITS_CHECK_CV(true , Abstract, TC29<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC30<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC31<int>);
	IS_TRAITS_CHECK_CV(false, Abstract, TC32<int>);
