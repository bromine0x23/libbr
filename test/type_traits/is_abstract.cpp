...
TEST(TypeTraits, IsAbstract) {
	...
	IS_TRAITS_CHECK(false, Abstract, abstract, int &&);
	IS_TRAITS_CHECK(false, Abstract, abstract, int []);
	IS_TRAITS_CHECK(false, Abstract, abstract, int [2]);
	IS_TRAITS_CHECK(false, Abstract, abstract, CFunction<int, int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, CFunction<int, int> *);
	IS_TRAITS_CHECK(false, Abstract, abstract, int Class::*);
	IS_TRAITS_CHECK(false, Abstract, abstract, CFunction<int, int> Class::*);
	IS_TRAITS_CHECK(false, Abstract, abstract, NullPointer);
	IS_TRAITS_CHECK(false, Abstract, abstract, Class);
	IS_TRAITS_CHECK(false, Abstract, abstract, Struct);
	IS_TRAITS_CHECK(false, Abstract, abstract, Union);
	IS_TRAITS_CHECK(false, Abstract, abstract, Enum);
	IS_TRAITS_CHECK(false, Abstract, abstract, EnumClass);

	IS_TRAITS_CHECK(false, Abstract, abstract, C00);
	IS_TRAITS_CHECK(true , Abstract, abstract, C01);
	IS_TRAITS_CHECK(true , Abstract, abstract, C02);
	IS_TRAITS_CHECK(false, Abstract, abstract, C03);
	IS_TRAITS_CHECK(true , Abstract, abstract, C04);
	IS_TRAITS_CHECK(true , Abstract, abstract, C05);
	IS_TRAITS_CHECK(false, Abstract, abstract, C06);
	IS_TRAITS_CHECK(false, Abstract, abstract, C07);
	IS_TRAITS_CHECK(true , Abstract, abstract, C08);
	IS_TRAITS_CHECK(false, Abstract, abstract, C09);
	IS_TRAITS_CHECK(true , Abstract, abstract, C10);
	IS_TRAITS_CHECK(false, Abstract, abstract, C11);
	IS_TRAITS_CHECK(true , Abstract, abstract, C12);
	IS_TRAITS_CHECK(true , Abstract, abstract, C13);
	IS_TRAITS_CHECK(true , Abstract, abstract, C14);
	IS_TRAITS_CHECK(false, Abstract, abstract, C15);
	IS_TRAITS_CHECK(true , Abstract, abstract, C16);
	IS_TRAITS_CHECK(true , Abstract, abstract, C17);
	IS_TRAITS_CHECK(false, Abstract, abstract, C18);
	IS_TRAITS_CHECK(false, Abstract, abstract, C19);
	IS_TRAITS_CHECK(true , Abstract, abstract, C20);
	IS_TRAITS_CHECK(false, Abstract, abstract, C21);
	IS_TRAITS_CHECK(true , Abstract, abstract, C22);
	IS_TRAITS_CHECK(false, Abstract, abstract, C23);
	IS_TRAITS_CHECK(true , Abstract, abstract, C24);
	IS_TRAITS_CHECK(true , Abstract, abstract, C25);
	IS_TRAITS_CHECK(true , Abstract, abstract, C26);
	...
	IS_TRAITS_CHECK(true , Abstract, abstract, TC01<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC02<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC03<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC04<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC05<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC06<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC07<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC08<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC09<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC10<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC11<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC12<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC13<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC14<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC15<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC16<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC17<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC18<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC19<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC20<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC21<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC22<int>);
	IS_TRAITS_CHECK(false, Abstract, abstract, TC23<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC24<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC25<int>);
	IS_TRAITS_CHECK(true , Abstract, abstract, TC26<int>);
