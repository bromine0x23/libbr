...
TEST(TypeTraits, IsConstructible) {
	...
	IS_TRAITS_CHECK(true , Constructible, constructible, AnyConstructor);
	IS_TRAITS_CHECK(true , Constructible, constructible, AnyConstructor, int);
	IS_TRAITS_CHECK(true , Constructible, constructible, AnyConstructor, int, char);
	IS_TRAITS_CHECK(true , Constructible, constructible, AnyConstructor, int, char, short(*)[2]);
	IS_TRAITS_CHECK(true , Constructible, constructible, AnyConstructor, int, char, short(*)[2], bool(&&)(double));

	IS_TRAITS_CHECK(true, Constructible, constructible, ExplicitConstruct, int &);
	IS_TRAITS_CHECK(true, Constructible, constructible, ExplicitConstruct, double &);
	IS_TRAITS_CHECK(true, Constructible, constructible, ExplicitConstruct, int &, double &);
}