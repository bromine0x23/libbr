 ...
 */
template< typename T >
struct IsMemberFunctionPointer : BooleanRewrapPositive< Detail::TypeTraits::IsMemberFunctionPointer<T> > {};
 ...
 */
template< typename T >
struct NotMemberFunctionPointer : BooleanRewrapNegative< Detail::TypeTraits::IsMemberFunctionPointer<T> > {};
