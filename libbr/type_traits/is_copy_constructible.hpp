 ...
 */
template< typename T >
struct IsCopyConstructible : BooleanRewrapPositive< Detail::TypeTraits::IsCopyConstructible<T> > {};
 ...
 */
template< typename T >
struct NotCopyConstructible : BooleanRewrapNegative< Detail::TypeTraits::IsCopyConstructible<T> > {};
 ...
 */
template< typename T >
constexpr auto is_copy_constructible = bool_constant< IsCopyConstructible<T> >;
 ...
 */
template< typename T >
constexpr auto not_copy_constructible = bool_constant< NotCopyConstructible<T> >;
