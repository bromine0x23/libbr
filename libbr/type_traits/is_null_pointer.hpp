 ...
 */
template< typename T >
struct IsNullPointer : BooleanRewrapPositive< Detail::TypeTraits::IsNullPointer<T> > {};
 ...
 */
template< typename T >
struct NotNullPointer: BooleanRewrapNegative< Detail::TypeTraits::IsNullPointer<T> > {};
