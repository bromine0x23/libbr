...
struct IsVirtualBaseOfBasic {
	struct Tester0 : public TDerived, public virtual TBase {
		Tester0();
...
template< typename TBase, typename TDerived, bool = BooleanAnd< IsBaseOf< TBase, TDerived >, NotSame< TBase, TDerived > >{}() >
struct IsVirtualBaseOf;

template< typename TBase, typename TDerived >
struct IsVirtualBaseOf< TBase, TDerived, true > : public BooleanConstant< IsVirtualBaseOfBasic< TBase, TDerived >::value > {};

template< typename TBase, typename TDerived >
struct IsVirtualBaseOf< TBase, TDerived, false > : public BooleanFalse {};
