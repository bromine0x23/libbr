...
#define BR_TYPE_OPERATE_OP_NAME_C SuffixDecrement
#define BR_TYPE_OPERATE_OP_NAME_V suffix_decrement
...
#include <libbr/type_traits/detail/has_suffix_operator.inc>