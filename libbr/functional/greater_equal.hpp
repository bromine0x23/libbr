...
struct GreaterEqual : public BinaryFunctor< TX, TY > {
...
struct GreaterEqual< TX, void > : public BinaryFunctor< TX, void > {
...
template< typename TY >
struct GreaterEqual< void, TY > : public BinaryFunctor< void, TY > {
	template< typename TX >
