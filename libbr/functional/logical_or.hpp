...
struct LogicalOr : public BinaryFunctor< TX, TY > {
...
struct LogicalOr< TX, void > : public BinaryFunctor< TX, void > {
...
template< typename TY >
struct LogicalOr< void, TY > : public BinaryFunctor< void, TY > {
	template< typename TX >
