...
struct LogicalAnd : public BinaryFunctor< TX, TY > {
...
struct LogicalAnd< TX, void > : public BinaryFunctor< TX, void > {
...
template< typename TY >
struct LogicalAnd< void, TY > : public BinaryFunctor< void, TY > {
	template< typename TX >
