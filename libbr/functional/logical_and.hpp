/**
 * @file
 * @brief class LogicalAnd<TLhs, TRhs>
 * @author Bromine0x23
 * @since 2015/10/30
 */
#pragma once
...
struct LogicalAnd : public BinaryFunctor< TLhs, TRhs > {
...
struct LogicalAnd< TLhs, void > : public BinaryFunctor< TLhs, void > {
...
template< typename TRhs >
struct LogicalAnd< void, TRhs > : public BinaryFunctor< void, TRhs > {
	template< typename TLhs >
...
template<>
struct LogicalAnd< void, void > : public BinaryFunctor< void, void > {
	template< typename TLhs, typename TRhs >
