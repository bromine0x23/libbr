...
constexpr static BR::UInt8 LIBBER_REVERSE_BITS[] = {
 ...
 */
//@{
constexpr auto libbr_reverse_bits_8(BR::UInt8 x) noexcept -> BR::UInt8 {
	return LIBBER_REVERSE_BITS[x];
}

constexpr auto libbr_reverse_bits_16(BR::UInt16 x) noexcept -> BR::UInt16 {
	return libbr_combine_bits_16(libbr_reverse_bits_8(libbr_low_bits_16(x)), libbr_reverse_bits_8(libbr_high_bits_16(x)));
}

constexpr auto libbr_reverse_bits_32(BR::UInt32 x) noexcept -> BR::UInt32 {
	return libbr_combine_bits_32(libbr_reverse_bits_16(libbr_low_bits_32(x)), libbr_reverse_bits_16(libbr_high_bits_32(x)));
}

constexpr auto libbr_reverse_bits_64(BR::UInt64 x) noexcept -> BR::UInt64 {
	return libbr_combine_bits_64(libbr_reverse_bits_32(libbr_low_bits_64(x)), libbr_reverse_bits_32(libbr_high_bits_64(x)));
}

#ifdef BR_HAS_INT128
constexpr auto libbr_reverse_bits_128(BR::UInt128 x) noexcept -> BR::UInt128 {
	return libbr_combine_bits_128(libbr_reverse_bits_64(libbr_low_bits_128(x)), libbr_reverse_bits_64(libbr_high_bits_128(x)));
}
#endif
//@}
}
...
constexpr auto reverse_bits(UInt8 x) noexcept -> UInt8 {
	return libbr_reverse_bits_8(x);
}

constexpr auto reverse_bits(UInt16 x) noexcept -> UInt16 {
	return libbr_reverse_bits_16(x);
}

constexpr auto reverse_bits(UInt32 x) noexcept -> UInt32 {
	return libbr_reverse_bits_32(x);
}

constexpr auto reverse_bits(UInt64 x) noexcept -> UInt64 {
	return libbr_reverse_bits_64(x);
}

#ifdef BR_HAS_INT128
constexpr auto reverse_bits(UInt128 x) noexcept -> UInt128 {
	return libbr_reverse_bits_128(x);
}
#endif
