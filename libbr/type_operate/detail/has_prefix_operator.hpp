...
#define BR_TYPE_OPERATE_NAMESPACE BR_JOIN(PrefixOperator, BR_TYPE_OPERATE_OP_NAME)
...
template< typename TRhs, typename TRet = Detail::BR_TYPE_OPERATE_NAMESPACE::NotCareTag >
struct BR_JOIN(HasOperator, BR_TYPE_OPERATE_OP_NAME) : Boolean<
	Detail::BR_TYPE_OPERATE_NAMESPACE::HasOperator< TRhs, TRet >
> {};
