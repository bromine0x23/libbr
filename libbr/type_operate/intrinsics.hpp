...
#  define BR_HAS_TRIVIAL_COPY_CONSTRUCTOR(T) (__has_trivial_copy(T)|| ::BR::BooleanAnd< ::BR::IsPOD<T>::value, ::BR::NotVolatile<T> >::value))
#  define BR_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) ((__has_trivial_move_constructor(T) || ::BR::IsPOD<T>::value) && ::BR::BooleanAnd< ::BR::NotVolatile<T>, ::BR::NotReference<T> >::value)
#  define BR_HAS_TRIVIAL_COPY_ASSIGNMENT(T) (__has_trivial_assign(T) || ::BR::BooleanAnd< ::BR::IsPOD<T>, ::BR::NotConst<T>, ::BR::NotVolatile<T> >::value)
#  define BR_HAS_TRIVIAL_MOVE_ASSIGNMENT(T) (__has_trivial_move_assign(T) || ::BR::IsPOD<T>::value) && ::BR::BooleanAnd< ::BR::NotConst<T>, ::BR::NotVolatile<T>, ::BR::NotReference<T> >::value)
#  define BR_HAS_TRIVIAL_DESTRUCTOR(T) (__has_trivial_destructor(T) || ::BR::IsPOD<T>::value)
