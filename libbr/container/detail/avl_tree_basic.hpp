...
#include <libbr/container/detail/avl_tree_algorithms.hpp>
#include <libbr/container/detail/avl_tree_node.hpp>
...
struct Traits {
	...
	using Node = AVLTree::Node<TElement, TVoidPointer>;

	template< typename TNodePointer >
	using Algorithms = AVLTree::Algorithms<TNodePointer>;
};
