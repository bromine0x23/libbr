...
private:
	...
	using Tree = TTree< Pair<Key, Value>, Comparator, Allocator, TOtherTreeArgs... >;
...
public:
	...
	auto count(Element const & key) const -> Size {
...
}; // class TreeMap<TKey, TValue, TKeyComparator, TAllocator, TTree, TArgs>
